                  ...
                  <thead>
                    <tr>
                      <th style={{ textAlign: "left" }}>
                        Auto Driving Licence
                      </th>
                      <th style={{ textAlign: "right" }}>LKR 17,500</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td style={{ textAlign: "left" }}>Advanced</td>
                      <td style={{ textAlign: "right" }}>LKR 5000</td>
                    </tr>
                    <tr>
                      <td style={{ textAlign: "left" }}>06 Mar 2019</td>
                      <td style={{ textAlign: "right" }}>LKR 6000</td>
                    </tr>
                    <tr>
                      <td style={{ textAlign: "left" }}>18 Jun 2019</td>
                      <td style={{ textAlign: "right" }}>LKR 4000</td>
                    </tr>
                    <tr>
                      <td style={{ textAlign: "left" }}>Balanced to be paid</td>
                      <td style={{ textAlign: "right" }}>LKR 2,500</td>
                    </tr>
                  </tbody>
                </Table>
                <FormGroup row>
